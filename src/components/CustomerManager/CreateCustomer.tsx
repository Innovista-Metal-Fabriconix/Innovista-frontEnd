...
const onFinish = async (values: CustomerFormValues): Promise<void> => {
    try {
        // Shape the customer object
        const customerData: CustomerData = {
            CustomerId: 1, // Could be auto-generated by backend
        ...
        const res: Response = await fetch(
            "http://localhost:4000/customer/Customer_register",
            {
                method: "POST",
                headers: {
  ...
  return (
    <div style={{ maxWidth: 600, margin: "0 auto", padding: 20 }}>
      <h2 style={{ textAlign: "center", marginBottom: 20 }}>Register Customer</h2>
      <Form
        form={form}
        layout="vertical"
        onFinish={onFinish}
      >
        ...
        >
          <Select mode="tags" placeholder="Select or add goods">
            <Select.Option value="Office Furniture">Office Furniture</Select.Option>
