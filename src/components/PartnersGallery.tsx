...
export default function PartnersGallery({
  ...
  const startInertia = useCallback(
    ...
    [dragDampening, responsiveConfig.maxVerticalRotationDeg, stopInertia],
  );
  ...
  return (
    <div
      ...
      style={{
        ["--segments-x"]: responsiveConfig.segments,
        ["--segments-y"]: responsiveConfig.segments,
